...
const frontend = [
    ...
    {name: 'JavaScript', icon: <BiLogoTypescript className="size-5"></BiLogoTypescript>},
            ...
            <div className="max-w-5xl mx-auto text-center">
                ...
                <div className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-7">
                    {sections.map((section) => (
                        <div
                            className="bg-gray-700 rounded-lg shadow-lg shadow-black/40 p-6 transition-transform transform">
